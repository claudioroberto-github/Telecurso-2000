    ...
    <nav class="nav bd-container">
      ...
      <div class="nav__menu" id="nav-menu">
        <ul class="nav__list">
          ...
          <li class="nav__item"><a href="login.php" class="nav__link">Sing Up/Log In</a></li>
    ...
    <section class="home" id="home">
      <div class="home__container bd-container bd-grid">
        <div class="home__data">
          <h1 class="home__title">Best Menus</h1>
          <h2 class="home__subtitle">The best menus for you and yours Business.</h2>
    ...
    <section class="about section bd-container" id="about">
      <div class="about__container  bd-grid">
        <div class="about__data">
          ...
          <h2 class="section-title about__initial">Much more communication <br>and control</h2>
          <p class="about__description">With our systems, there is greater control over your inventory, communication between employees and resource management.</p>
